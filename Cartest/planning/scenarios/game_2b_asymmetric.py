"""Two-agent asymmetric Constran collision-game scenario."""

from Cartest.core.reference_path import StraightReference


COST_NAME = "game_2b_constran"
...
SCENARIO = {
    ...
    "agents": [
        {"name": "agent0", "role": "ego", "s": 0.0, "s_dot": 16.0, "s_ddot": 0.0,
         "d": -3.0, "d_dot": 0.0, "d_ddot": 0.0, "psi": 0.0, "v_target": 18.0},
        {"name": "agent1", "role": "peer", "s": 8.0, "s_dot": 8.0, "s_ddot": 0.0,
         "d": 0.0, "d_dot": 0.0, "d_ddot": 0.0, "psi": 0.0, "v_target": 10.0},
    ],
    "game": {
        "solver": "rne_blocks",
    ...
    "behavior": {"target_d": 0.0, "speed_factors": (1.15, 1.0, 0.5)},
